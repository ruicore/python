...
# @Last Modified by:   何睿
# @Last Modified time: 2018-11-11 14:39:54
...
from secret import baidu


# 百度云 人脸检测 申请信息
APP_ID = baidu.get("face").get("APP_ID")
API_KEY = baidu.get("face").get("API_KEY")
SECRET_KEY = baidu.get("face").get("SECRET_KEY")
